...
from controllers import index_controller, map_controller, country_info_controller, login_controller, logout_controller, register_controller, flashcard_controller
